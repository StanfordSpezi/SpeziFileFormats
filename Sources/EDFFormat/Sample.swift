...
public struct BDFSample {
    ...
    public let value: Int32 // TODO: it's 24 bit though!
}
...
public protocol Sample: ByteEncodable { // TODO: support decoding?
...
extension BDFSample: ByteEncodable {
...
extension EDFSample: ByteEncodable {
    public func encode(to byteBuffer: inout ByteBuffer, preferredEndianness endianness: Endianness) {
